...
from models.TransMorph_DSwin3D_DynConv_Matched import CONFIGS as CONFIGS_TM
import models.TransMorph_DSwin3D_DynConv_Matched as TransMorphDSwin3DDynConvMatched
...
def main():
    ...
    model_idx = -1
    weights = [1, 1]
    model_folder = 'TransMorph_DSwin3D_DynConv_Matched_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    config = CONFIGS_TM['TransMorph-DSwin3D-DynConv-Matched']
    model = TransMorphDSwin3DDynConvMatched.TransMorphDSwin3DDynConv(config)
