...
from models.TransMorph_bspl_DSwin3D_AGDynConv_Lite_Expanded import (
    TranMorphBSplineDSwinAGDynConvLiteExpandedNet,
...
def main():
    ...
    save_dir = 'TransMorphBSpline_DSwin3D_AGDynConv_Lite_Expanded_e64_rc24_AdamW_MultiNCC3_9_15_detachTrue_offmag_{}_offsmooth_{}/'.format(
    ...
    print('Using MultiScaleNCC_vxm with windows: {}'.format(ncc_wins))
    lr = 0.0001
    epoch_start = 0
    max_epoch = 500
    cont_training = False

    model = TranMorphBSplineDSwinAGDynConvLiteExpandedNet(config)
    model.cuda()
    ...
    criterions = [losses.MultiScaleNCC_vxm(wins=ncc_wins), losses.Grad3d(penalty='l2')]
    best_dsc = 0
    ...
    for epoch in epoch_pbar:
        ...
        writer.add_scalar('Loss/sim_multiscale_ncc', sim_all.avg, epoch)
