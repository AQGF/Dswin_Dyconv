...
def main():
    ...
    model_idx = -1
    weights = [1, 1]
    model_folder = 'TransMorphBSpline_DSwin3D_DynConv_Lite_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    config = CONFIGS_TM['TransMorphBSpline-DSwin3D-DynConv-Lite']
    model = TransMorph_bspl_DSwinDynConvLite.TranMorphBSplineDSwinDynConvLiteNet(config)
