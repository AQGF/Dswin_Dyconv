...
from models.TransMorph_DSwin3D_AGDynConv import CONFIGS as CONFIGS_TM
from models.TransMorph_DSwin3D_AGDynConv import TransMorphDSwin3DAGDynConv
...
def main():
    ...
    model_idx = -1
    config = CONFIGS_TM['TransMorph-DSwin3D-AGDynConv']
    weights = [1, 1]
    model_folder = 'TransMorph_DSwin3D_AGDynConv_ncc_{}_diffusion_{}_offmag_{}_offsmooth_{}/'.format(
        weights[0],
        weights[1],
    ...
    model = TransMorphDSwin3DAGDynConv(config)
