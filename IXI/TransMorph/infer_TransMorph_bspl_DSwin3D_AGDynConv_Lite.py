...
import models.TransMorph_bspl_DSwin3D_AGDynConv_Lite as TransMorph_bspl_DSwinAGDynConvLite
...
def main():
    ...
    weights = [1, 1]
    model_folder = 'TransMorphBSpline_DSwin3D_AGDynConv_Lite_ncc_{}_diffusion_{}_offmag_{}_offsmooth_{}/'.format(
        weights[0],
        weights[1],
    ...
    model = TransMorph_bspl_DSwinAGDynConvLite.TranMorphBSplineDSwinAGDynConvLiteNet(config)
