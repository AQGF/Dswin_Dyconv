...
import models.configs_TransMorph_bspl_DSwin3D_AGDynConv_Lite as configs
...
class TranMorphBSplineDSwinAGDynConvLiteNet(nn.Module):
...
CONFIGS = {
    'TransMorphBSpline-DSwin3D-AGDynConv-Lite': configs.get_TransMorphBsplDSwinAGDynConvLite_config(),
