...
import models.configs_TransMorph_bspl_DSwin3D_AGDynConv_Lite_Expanded as configs
from models.TransMorph_DSwin3D_AGDynConv import (
    DSwinEncoderAGDynConv3D,
...
class TranMorphBSplineDSwinAGDynConvLiteExpandedNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return y, flow, disp, {'attn_aux': attn_aux}


CONFIGS = {
    'TransMorphBSpline-DSwin3D-AGDynConv-Lite-Expanded': configs.get_TransMorphBsplDSwinAGDynConvLiteExpanded_config(),
    'offset_mag_loss': compute_offset_magnitude_loss,
    'offset_smooth_loss': compute_offset_smoothness_loss,
}
